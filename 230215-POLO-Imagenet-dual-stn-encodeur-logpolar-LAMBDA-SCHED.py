...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model, f"230215_polo_stn_dual_lambda_{LAMBDA}_mixed.pt")
        np.save(f"230215_polo_stn_dual_lambda_{LAMBDA}_mixed_acc", acc)
        np.save(f"230215_polo_stn_dual_lambda_{LAMBDA}_mixed_loss", loss)
        np.save(f"230215_polo_stn_dual_lambda_{LAMBDA}_mixed_kl_loss", kl_loss)
