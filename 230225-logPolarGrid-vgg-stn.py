...
for epoch in range(args.epochs):
    ...
    torch.save(model, f"out/230225_logPolarGrid_vgg_stn_{LAMBDA}_{args.radius}_{deterministic}.pt")
    with open(f"out/230225_logPolarGrid_vgg_stn_{LAMBDA}_{args.radius}_{deterministic}.pkl", "wb") as f:
        train_data = {
                "train_acc" : train_acc,
