...
class Grid_AttentionTransNet(nn.Module):
    ...
    def __init__(self, do_stn=True, do_what=False, LAMBDA=.1, deterministic=False):
        ...
        ##  The where pathway        
        self.num_features = 7 * 7 #self.vgg_where.classifier[-1].in_features
...
f_name = f"230516_ImgNet_logPolarGrid_vgg_stn_{radius}_{LAMBDA}_{deterministic}_jnj_grid_SGD"
