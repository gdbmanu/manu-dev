...
f_load = f"230407b_ImgNet_logPolarGrid_vgg_stn_{radius}_{LAMBDA}_contrast_SGD_lr3-9"
f_name = f"230407c_ImgNet_logPolarGrid_vgg_stn_{radius}_{LAMBDA}_contrast_SGD_lr3-9"
