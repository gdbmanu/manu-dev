...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model, f"low_comp_polo_stn_dual_lambda_{LAMBDA}_mixed.pt")
        np.save(f"low_comp_polo_stn_dual_lambda_{LAMBDA}_mixed_acc", acc)
        np.save(f"low_comp_polo_stn_dual_lambda_{LAMBDA}_mixed_loss", loss)
        np.save(f"low_comp_polo_stn_dual_lambda_{LAMBDA}_mixed_kl_loss", kl_loss)
