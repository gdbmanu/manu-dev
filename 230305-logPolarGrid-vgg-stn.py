...
for epoch in range(args.epochs):
    ...
    torch.save(model, f"out/230305_logPolarGrid_vgg_stn_{LAMBDA}_{args.radius}.pt")
    with open(f"out/230305_logPolarGrid_vgg_stn_{LAMBDA}_{args.radius}.pkl", "wb") as f:
        train_data = {
                "train_acc" : train_acc,
